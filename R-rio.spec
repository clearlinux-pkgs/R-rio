...
Version  : 1.2.1
Release  : 60
URL      : https://cran.r-project.org/src/contrib/rio_1.2.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rio_1.2.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722279509
