...
Version  : 1.1.1
Release  : 58
URL      : https://cran.r-project.org/src/contrib/rio_1.1.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rio_1.1.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717722272
